...
if __name__=="__main__":
    ...
    parser.add_argument("--lr",default=1e-04,help="learning rate")
    ...
    # config_file_name,extension = os.path.splitext(os.path.basename(training_args.config_path))
    # train_file_name, extension = os.path.splitext(os.path.basename(training_args.train_path))

    # tf_board_name=config_file_name+"_"+train_file_name
